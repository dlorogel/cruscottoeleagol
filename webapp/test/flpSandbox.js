		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cruscotto preapprovazione doc. contabili da Elea Gol",
									"targetURL": "#itorogelzcruscottoeleagol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelzcruscottoeleagol-display": {
								"semanticObject": "itorogelzcruscottoeleagol",
								"action": "display",
								"description": "Cruscotto preapprovazione doc. contabili da Elea Gol",
								"title": "Cruscotto preapprovazione doc. contabili da Elea Gol",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.zcruscottoeleagol",
									"url": sap.ui.require.toUrl("it/orogel/zcruscottoeleagol")
								}
							}
						}
					}
